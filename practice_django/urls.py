...
from django.conf.urls.static import static  # import static method to handle static files
...
urlpatterns = [
    ...
    # Set-up password recovery paths
    path('reset_password/', auth_views.PasswordResetView.as_view(template_name="reset_password.html"),
         name="reset_password"),        # Must type correct name convention
                                        # template_name="your custome template"
